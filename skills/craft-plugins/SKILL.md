...
| `references/imager-x.md` | Imager X (spacecatninja) | Front-end + config | Quick syntax, responsive srcset, named transforms, Power Pack markup (`ppimg`/`pppicture`), automatic generation, transformers, effects, optimizers |
