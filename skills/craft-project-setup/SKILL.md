...
┌────────────────────────────────────────────────────────────┐
│                                                            │
│   +  Craft CMS Claude Skills  ·  v1.17.0                   │
│                                                            │
...
2. **CLAUDE.md HTML comment** — first line of the generated file:
   ```markdown
   <!-- craftcms-claude-skills v1.17.0 -->
   ```
...
3. **Compare** — identify what the existing config has vs what a fresh scaffold would produce. Look for:
   ...
   - Version drift (e.g., `craftcms-claude-skills` marker says `1.1.0` but current is `1.17.0`)
...
| CLAUDE.md skill version | v1.1.0 | v1.17.0 | Update marker |
