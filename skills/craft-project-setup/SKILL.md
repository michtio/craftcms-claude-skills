...
┌────────────────────────────────────────────────────────────┐
│                                                            │
│   +  Craft CMS Claude Skills  ·  v1.6.5                    │
│                                                            │
...
3. **Compare** — identify what the existing config has vs what a fresh scaffold would produce. Look for:
   ...
   - Version drift (e.g., `craftcms-claude-skills` marker says `1.1.0` but current is `1.6.5`)
...
| CLAUDE.md skill version | v1.1.0 | v1.6.5 | Update marker |
